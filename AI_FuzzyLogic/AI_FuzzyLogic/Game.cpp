...
void Game::update(float dt)
{
	...
	//Calculate the new velocity which is the rate of change over time.
	f_velocity = (f_distance - output->getValue())*dt;

	//Make the car move.
	Car.move(f_velocity*speed, 0);
...
void Game::stage1()
{
	...
	//Give instructions and read the second input
	if (in1 != 3) {
